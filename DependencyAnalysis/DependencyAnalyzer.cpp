/////////////////////////////////////////////////////////////////////
// DependencyAnalyzer.cpp - Conduct Dependency Analysis            //
//                                                                 //
	 ...
	 table_(table)
{
	...
	for (auto file : hFiles)
		db_.addEntry(file, Database::EntryValue());
	for (auto file : impleFiles)
		db_.addEntry(file, Database::EntryValue());
}
...
//----< return dependencies result by NoSql database >--------------------------------

DepAnalyzer::Database DepAnalyzer::getResult() {
	return db_;
}
